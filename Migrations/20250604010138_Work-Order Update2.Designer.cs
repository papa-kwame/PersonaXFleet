...
namespace PersonaXFleet.Migrations
{
    ...
    [Migration("20250604010138_Work-Order Update2")]
    partial class WorkOrderUpdate2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonaXFleet.Models.WorkOrder", b =>
                {
                    ...
                    b.Property<string>("AssignedMechanicId1")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("AssignedMechanicId1");
            ...
            modelBuilder.Entity("PersonaXFleet.Models.WorkOrderTask", b =>
                {
            ...
            modelBuilder.Entity("PersonaXFleet.Models.WorkOrder", b =>
                {
                    b.HasOne("PersonaXFleet.Models.ApplicationUser", "AssignedTechnician")
                        .WithMany()
                    ...
                    b.HasOne("PersonaXFleet.Models.ApplicationUser", "AssignedMechanic")
                        .WithMany()
                        .HasForeignKey("AssignedMechanicId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PersonaXFleet.Models.WorkOrderTask", b =>
                {
                    b.HasOne("PersonaXFleet.Models.WorkOrder", "WorkOrder")
                        .WithMany("Tasks")
