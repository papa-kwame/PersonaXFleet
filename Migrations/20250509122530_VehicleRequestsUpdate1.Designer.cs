...
namespace PersonaXFleet.Migrations
{
    ...
    [Migration("20250509122530_VehicleRequestsUpdate1")]
    partial class VehicleRequestsUpdate1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PersonaXFleet.Models.MaintenanceApproval", b =>
                {
                    b.HasOne("PersonaXFleet.Models.MaintenanceRequest", "MaintenanceRequest")
                        .WithOne("Approval")
                        .HasForeignKey("PersonaXFleet.Models.MaintenanceApproval", "MaintenanceRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
